...
|Prototype (screens & key elements)| Big central camera view with a single-shot scan button labeled “Scan product”. Small toggle: Barcode / Image / Manual look-up. Top-right: Profile & saved lists icon.|
